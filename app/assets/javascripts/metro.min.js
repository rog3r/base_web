...
(function (c) {
    c.widget("metro.metrodatepicker", {version: "1.0.0", options: {format: "dd.mm.yyyy", date: void 0, effect: "none", position: "bottom", locale: c.Metro.currentLocale, weekStart: void 0 != METRO_WEEK_START ? METRO_WEEK_START : 0, otherDays: !1, selected: function (a, b) {
...
(function (c) {
    c.widget("metro.hint", {version: "1.0.0", options: {position: "bottom", background: "#FFFCC0", shadow: !1, border: !1, mode: 1, _hint: void 0}, _create: function () {
        ...
        "top" == d.position ? b.css({top: a.offset().top - c(window).scrollTop() - b.outerHeight() - 20, left: 2 == d.mode ? a.offset().left + a.outerWidth() / 2 - b.outerWidth() / 2 - c(window).scrollLeft() : a.offset().left - c(window).scrollLeft()}) : "bottom" ==
...
(function (c) {
    ...
    c.Metro.initDatepickers = function (a) {
        void 0 != a ? c(a).find("[data-role=metrodatepicker]").metrodatepicker() : c("[data-role=metrodatepicker]").metrodatepicker()
    };
